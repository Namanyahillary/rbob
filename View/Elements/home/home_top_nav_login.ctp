...
<div class="navbar-inner">
  <div class="container">
	...
	<a class="brand" href="<?php echo $url; ?>"><?php echo $this->Html->image('logo.png',array('width'=>'75%','style'=>'width:75%')); ?></a>
	<div id="primary-nav" class="nav-collapse">
	  ...
	  <ul class="nav pull-right">
		...
		<li class="active1"><a href="#"></a>
			<div>
				<form action="<?php echo $this->webroot.'users/login';?>" id="UserLoginForm" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"></div>
				<span style="color:#fff;">Username</span> <input type="text" name="data[User][username]" required="" placeholder="Enter username" /> 
				<span style="color:#fff;">Password</span> <input type="password" name="data[User][password]" required="" placeholder="Enter password" />
		...
		<li>
			<button style="margin-top: 23%;" type="submit" class="btn btn-success"><a href="<?php echo $this->webroot.'users/register';?>" style="color:#fff"><i class="icon-white icon-th"></i> Sign up</a></button>
		</li>
