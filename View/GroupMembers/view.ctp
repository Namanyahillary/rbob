...
<h2><?php  echo __('Group Member'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($groupMember['User']['name'], array('controller' => 'users', 'action' => 'view', $groupMember['User']['id'])); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Date'); ?></dt>
		<dd>
			<?php echo h($groupMember['GroupMember']['date']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Group Member'), array('action' => 'delete', $groupMember['GroupMember']['id']), null, __('Are you sure you want to delete # %s?', $groupMember['GroupMember']['id'])); ?> </li>
